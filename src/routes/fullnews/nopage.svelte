        ...
        <div class="flex flex-col sm:flex-row mt-10">
          ...
          <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
            <p class="leading-relaxed text-lg mb-4">
                ...
                direct trade art party. Locavore small batch listicle gastropub farm-to-table lumbersexual salvia messenger bag. Coloring book 
                flannel truffaut craft beer drinking vinegar sartorial, disrupt fashion axe normcore meh butcher. Portland 90's scenester 
                vexillologist forage post-ironic asymmetrical, chartreuse disrupt butcher paleo intelligentsia pabst before they sold out four loko.
                 3 wolf moon brooklyn. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellendus quasi eos qui cumque quia, modi consequatur sint similique atque officia placeat aperiam obcaecati minima enim assumenda quidem dolores iusto odio. Molestias ex eveniet atque unde molestiae soluta eum ipsam quas!
                </p>
  ...
  <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
      <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
          <header class="mb-4 lg:mb-6 not-format">
              ...
              <h1 class="mb-4 text-3xl font-extrabold leading-tight text-white">Best practices for successful prototypes</h1>
          </header>
